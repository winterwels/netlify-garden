...
# 지수재
Back: 
지수재, 또는 지수판은 [[PARA/20. A-Area/시공/콘크리트\|콘크리트]]의 [[PARA/20. A-Area/시공/이어치기\|이어치기]] 시 시공 joint 부분에 발생하는 누수, 침수 현상을 방지하고 지수 성능을 유지하기 위해 설치하는 것이다. 수팽창성 고무 지수재는 습기와 접촉하면 팽창하여 공극을 충진한다

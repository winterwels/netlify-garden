...
https://cafe.naver.com/obsidianary/18965) 
[태그+PARA+MOC 제텔카스텐 사용법](https://cafe.naver.com/obsidianary/18700) 
[VAULT 구조 개인 사용례](https://cafe.naver.com/obsidianary/18656) 


이 페이지를 포함한 사이트는 [[PARA/20. A-Area/PKM/Obsidian\|Obsidian]] 의 [Digital Garden](https://dg-docs.ole.dev/) 플러그인을 통해 만들어졌읍니다. 호스팅은 [Netlify](https://app.netlify.com/) 에서 하고 있읍니다

- [목차가 있는 독서노트 반자동으로 만들기](https://cafe.naver.com/obsidianary/5525) : TEMPLATER, QUICKADD, DATAVIEW, BUTTONS 플러그인 4개로 설정.
...
- [미니멀리즘적으로 사용 (플러그인 최소화, 바닐라)](https://youtu.be/hSTy_BInQs8) : [[Tags/Child\|Child]]/[[Tags/Baby\|Baby]]/[[Tags/Adult\|#Adult]] 개념이 들어간 [[PARA/00. Inbox/Template 사용법\|Template 사용법]] 임

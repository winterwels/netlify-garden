---
{"dg-publish":true,"dg-permalink":"7.PARA/P-PROJECT/자기관리/ADHD/ADHD-환자를-위한-인지행동치료","permalink":"/7.PARA/P-PROJECT/자기관리/ADHD/ADHD-환자를-위한-인지행동치료/","created":"2026-03-23T10:58:24.079+09:00","dg-note-properties":{}}
---
...
- → 예상소요시간 산정 실패 / 또는 어려움
	...
	- ∴ 대책 : 일 시작 전 소요시간 예측 / 실제 완료 후 실 소요시간과 대비 → 간극 조정 (**자기객관화** 과정) = [[PARA/00. Inbox/자기이해\|자기이해]] 

## 2. 규칙적인 계획 세우기 (=루틴 형성) [[PARA/20. A-Area/습관\|습관]] 
- 매일 일상 패턴에 규칙성이 있음 (기상, 식사, 씻기, 출근, 퇴근, 청소, 운동, 수면 등)
- 이러한 행동 뭉치를 **패턴화 (=습관화)** 하라
- **★** 작게 시작하기
	- 처음에는 쉽게 할 수 있는 일 / 또는 즐거운 일부터 하기. ([[PARA/10. P-Project/1,000권 독서/Atomic Habits\|아주 작은 습관의 힘]] 中 `"습관 쌓기"` 전략)
...
- **★** 즉흥적으로 결정하지 말고, **미리 기준을 정해**두기
	- 판단기준 예 : 중요성과 긴급성 ([[아이젠하워 매트릭스\|아이젠하워 매트릭스]]) 

## 4. 정리하기 [[PARA/00. Inbox/ankified\|ankified]] 
- 정리의 어려움
